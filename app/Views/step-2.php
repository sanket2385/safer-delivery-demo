...
<head>
    <meta charset="UTF-8">
    <title>Safer.delivery - Step 2</title>
...
<body class="text-center">
  ...
  <form action="<?=base_url()?>home/step3">
    <div class="form-group">
      <h1>How can we best identify your property from your neighbours?</h1>
      <label for="name">e.g. Opposite the bus stop, Black wooden gate, green front door</label>
      ...
      <div class="row">
        <div class="col-sm">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="description1" rows="3" placeholder="Opposite the bus stop"></textarea>
          </div>
        </div>
        <div class="col-sm">
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="description2" rows="3" placeholder="Black wooden gate"></textarea>
          </div>
        </div>
        <div class="col-sm">
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="description3" rows="3" placeholder="Green front door"></textarea>
          </div>
        </div>
      </div>
    </div>
